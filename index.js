		...
		var clases = ['body','column', 'urlVideo', 'botton', 'container', 'embedVideo', 'flecha', 'size', 'code','copyBtn'];
		var el = {};
...
var containerYPrev  = 90
	...
	const  resizeX = e => {
				...
				document.documentElement.style.setProperty('--widthContainer', el.container.style.width)
			}
	...
	el.flecha.addEventListener('dblclick', e => {
		e.preventDefault()
		document.documentElement.style.setProperty('--widthContainer', '0px')
		setTimeout(() => {
		document.documentElement.style.setProperty('--widthContainer', el.container.style.width)
		},300)
	})
	...
	const removeResize = e => {
			...
			el.body.style.touchAction = 'auto'
